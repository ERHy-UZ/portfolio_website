...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className='bg-cyberblack shadow-xl shadow-cyberblack flex justify-between fixed top-0 left-0 right-0 py-5 pl-5 z-30'>
      ...
      <main className='blur-[0.5px] lg:blur-[0.7px] pb-16 pt-20'>
