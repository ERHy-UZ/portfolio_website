    ...
    <>
      ...
      <section className='grid lg:grid-cols-2 mt-2 lg:mt-4'>
        ...
        <div className='flex justify-center items-center'>
          <Image className='flex justify-center items-center text-cyberwhite font-w95f4 text-sm lg:text-2xl tracking-wider ' loading='lazy' src={''} alt='Imagen de José Antonio con su titulo' width={350} height={250} />
        </div>
      </section>
    </>
  )
