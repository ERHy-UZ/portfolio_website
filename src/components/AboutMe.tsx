...
export default function AboutMe() {
    return (
        <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6'>
            ...
            <div className='h-[7rem] lg:h-auto flex flex-col justify-center items-center bg-gradient-to-b from-cyberblue-200 to-cyberblue-300 rounded-sm border-t border-t-cybergreen-100 space-y-1'>
