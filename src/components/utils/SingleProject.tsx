...
export default function SingleProject({ image, title, descripciones: descripciones, techs, link }: ProjectType) {
    ...
    return (
        <motion.a
            ...
            <Image className='w-[40%] lg:w-[93%] h-full lg:h-[50%] lg:mt-4 mx-auto object-cover max-lg:rounded-s-2xl lg:rounded-t-2xl pointer-events-none' layout='responsive' src={image} alt='Imagen del proyecto' about='Proyecto' loading='lazy' width={168} height={168} />
