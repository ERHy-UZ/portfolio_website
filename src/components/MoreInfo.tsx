  ...
  return (
    <>
      ...
      <section className='grid lg:grid-cols-2 mt-2 lg:mt-4'>
        <div>
          <p className='text-sm lg:text-lg xl:text-2xl font-w95f4 tracking-wider text-cyberwhite 2xl:text-justify'>Actualmente, estoy enfocado en mejorar mis habilidades en tecnologías modernas como <strong className='text-cybergreen-200'>Azure, AWS, y Next.js</strong>, y me esfuerzo por mantenerme al día con las tendencias y mejores prácticas.</p>
        ...
        <div className='flex justify-center mt-2 lg:mt-4'>
          <Image className='rounded-md text-cyberwhite font-w95f4 text-sm lg:text-2xl tracking-wider pointer-events-none h-[200px] lg:h-[300px] w-[200px] lg:w-[300px]' loading='lazy' src={'/temp.jpg'} alt='Imagen de José Antonio' width={300} height={300} />
        </div>
      </section>
    </>
  )
